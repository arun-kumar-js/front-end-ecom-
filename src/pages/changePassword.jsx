...
const ChangePassword = () => {
  ...
  return (
    <div className=" w-full min-h-screen flex justify-center items-center">
      <div className=" p-8 rounded-lg shadow-2xl w-96">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lborder border-gray-600 focus:outline-none focus:border-blue-500"
              required
            />
          </div>
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg border border-gray-600 focus:outline-none focus:border-blue-500"
              required
            />
          </div>
          <button
